...
from duck_sourcecode.utils import load_user_data, dotdict, eval_gae, make_sparse, plot_results
from vgae_preprocessing import mask_test_edges, preprocess_graph
...
def main(args):
    ...
    # Load data
    np.random.seed(42)
    adj, features = load_user_data(args.dataset_str)
    N, D = features.shape
    ...
    #input_feat_dim, hidden_dim1, hidden_dim2, dropout
    gae = UserGAE(
              input_feat_dim = 512,
              hidden_dim1 = 256,
              hidden_dim2 = 128,
...
if __name__ == '__main__':
    ...
    args.dropout     = 0.2
    args.num_epochs  = 200
    args.dataset_str = 'twitter15' #twitter15, twitter16, CoAID
    args.test_freq   = 10
    args.lr          = 0.001
